...
def get_parser():
    ...
    parser.add_argument('--train_num', type=int, default=7120, help='train dataset num')
...
if __name__ == "__main__":
    ...
    # 线性学习率
    lr_scheduler = paddle.optimizer.lr.LambdaDecay(learning_rate=LR, lr_lambda=lambda x:1-x/float(NUM_EPOCHS+1), verbose=False)


    optimizer = paddle.optimizer.Momentum(learning_rate=lr_scheduler, parameters=model.net.parameters(), momentum=0.9,  
    weight_decay=5e-4)
